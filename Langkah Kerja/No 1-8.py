...
# Menyisipkan nilai ke dalam indeks
print('\nMenyisipkan nila 4 ke indeks terakhir dari a, dan 8 ke indeks terakhir dari b')
a.append(4)
b.append(8)
print('a = ', a)
print('b = ', b)
...
# Melakukan sorting
print('\nKemudian menyorting secara ascending pada list a dan b')
a.sort()
b.sort()
print('a = ', a)
print('b = ', b)
...
print('\nMengubah list ke dalam bentuk tuple')
Tuple = tuple(e)
print('e = ', Tuple)
